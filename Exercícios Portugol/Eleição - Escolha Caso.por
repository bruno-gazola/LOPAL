...
programa
{
    ...
    escreva("\nEscreva o nome do segundo candidato: ")
    leia(cdtb)
    escreva("\nEscreva o nome do terceiro candidato: ")
    leia(cdtc)
    escreva("\nEscolha o seu candidato ou tecle zero para encerrar\n\n")
    escreva("\n1- Candidato " + cdta )
    escreva("\n2- Candidato " + cdtb)
    escreva("\n3- Candidato " + cdtc)
    escreva("\n4- Branco")
    */
    ...
    leia(voto)
      ...
      porcentagem_brancos = (brancos * 100.0) / total_votos
			...
			escreva("Candidato " + cdtc + ": ", candidato_c, " voto(s). ", porcentagem_candidato_c, " % do total\n")
